...
<cffunction name="parseTagAttributes" output="No" returntype="Struct" hint="Parse attributes into a struct from a single tag string (e.g. [image id=xx]). Tag can be < or << or [ or [[ enclosed. Attributes can be single quoted, double quote or alpha numeric">
